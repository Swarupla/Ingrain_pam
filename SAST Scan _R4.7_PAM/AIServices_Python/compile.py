...
extensions=('.py')
exclude_directories=set(['large_models','__pycache__'])
...
not_needed_files=['webAPI.py','tasks.py','invokeIngestData.py','Next_Word.py','BestDeveloper.py','ModelSaver.py']
...
if platform.system()=='Windows':
    final_pyd_path=destination+'\\ai_services_pheonix'
elif platform.system()=='Linux':
    final_pyd_path=destination+'/ai_services_pheonix'
...
if platform.system()=='Windows':
    ...
    root_src_dir=local_path+"\\Cythonize\\ai_services_pheonix\\"
    root_dst_dir=local_path+"\\ai_services_pheonix\\"
elif platform.system()=='Linux':
    root_src_dir=local_path+"//Cythonize//ai_services_pheonix//"
    root_dst_dir=local_path+"//ai_services_pheonix//"
