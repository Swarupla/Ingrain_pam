...
def main(correlationId,modelName,pageInfo,userId,HyperTune=None,HTId=None,version=None):  
    ...
    # Fetching model parameters
        if HyperTune == 'True':
            ...
            MLDL_Model,_,ProblemType,traincols = utils.get_pickle_file(correlationId,'Ridge Regressor','MLDL_Model')                        
    ...
    # Pulling data
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Data Fetched at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))
...
#            trainData = trainData.drop(remove_uniqueid, axis=1)
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Test Train split started at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Model Defination Completed, Training for the model started at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        ...
        if HyperTune == 'True':            
         ...
         # Random search Cross Validate Model
            ...
            n_jobs= 1
            params = ridgeRegressor_RS_params()
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor: Model training completed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))        
        #print (model)
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Trained model saved at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))        
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Predictions done at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Model Evaluation completed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor : Model Feature Importance processed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        ...
        utils.logger(logger,correlationId,'INFO',('Ridge Regressor: Model Engineering completed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        utils.save_Py_Logs(logger,correlationId)       
