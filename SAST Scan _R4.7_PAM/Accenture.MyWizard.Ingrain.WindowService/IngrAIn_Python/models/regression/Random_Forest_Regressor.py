...
def main(correlationId,modelName,pageInfo,userId,HyperTune=None,HTId=None,version=None):  
    ...
    # Fetching model parameters
        if HyperTune == 'True':
            ...
            MLDL_Model,_,ProblemType,traincols = utils.get_pickle_file(correlationId,'Random Forest Regressor','MLDL_Model')                        
    ...
    # Pulling data
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor : Data Fetched at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))
...
#            trainData = trainData.drop(remove_uniqueid, axis=1)
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor: Test Train split started at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor : Model Defination Completed, Training the model started at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor : Model training completed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))        
        #print (model)
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor : Trained model saved at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))        
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor :Predictions done for at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None))
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor : Model Evaluation completed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        ...
        utils.logger(logger,correlationId,'INFO',('Random Forest Regressor : Model Feature Importance processed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        ...
        utils.logger(logger,correlationId,'INFO',('RFR Regressor : Model Engineering completed at : '+ str(datetime.today().strftime('%Y-%m-%d %H:%M:%S'))),str(None)) 
        utils.save_Py_Logs(logger,correlationId)       
