...
def main_wrapper(correlationId,uniqueId,pageInfo="publishModel",userId='System'):
    try:
        ...
        if len(data_json) == 1:
            ...
            main(correlationId,uniqueId,pageInfo,userId,data,Data,frequency,k,prediction = False)
            ...
            main(correlationId,uniqueId,pageInfo,userId,data,Data,frequency,k,prediction = True)
...
def main(correlationId,uniqueId,pageInfo,userId,data,Data,frequency,chunk_number,prediction):
    frequency = frequency
    data = data
    Data = Data
    logger = utils.logger('Get',correlationId)        
