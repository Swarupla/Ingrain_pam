...
extensions=('.py')
#exclude_directories=set(['Cythonize','SSAIutils'])
#exclude_directories=set(['backup scripts','Cython Scripts','Cythonize','MongoExport', 'POC', 'pylogs', 'server code', 'SSAIutils',  '__pycache__'])
...
#not_needed_files=['MigrateEnDe.py','uniqueIdentifierchanges.py','requirements.txt','__init__.py','realone.py','temp.py','k_means_RandomizedSearch.py','Affinity_Propagation_Clustering_Randomized_Search.py','visualizations.py''uniqueIdentifierchanges.py']
#not_needed_files=['__init__.py','Auth.py','decryption function.py','file_encryptor.py','invokeInferenceEngine.py', 'invokeInferenceEngine_bk.py', 'wsgi.py', 'app.py', 'app_bk.py',  'invokeIngestData.py', 'invokeIngestData_bk.py']
not_needed_files=['__init__.py','app.py','invokeIngestData.py']
...
if platform.system()=='Windows':
    final_pyd_path=destination+'\\main'
elif platform.system()=='Linux':
    final_pyd_path=destination+'/main'
...
if platform.system()=='Windows':
    ...
    root_src_dir=local_path+"\\Cythonize\\main\\"
    root_dst_dir=local_path+"\\main\\"
elif platform.system()=='Linux':
    root_src_dir=local_path+"//Cythonize//main//"
    root_dst_dir=local_path+"//main//"
...
try:           
    ...
    print("Cythonize Folder not removed")
