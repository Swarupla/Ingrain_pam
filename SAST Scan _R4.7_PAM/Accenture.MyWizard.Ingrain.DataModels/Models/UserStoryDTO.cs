...
namespace Accenture.MyWizard.Ingrain.DataModels.Models
{
    ...
    public class ClientStruct
    {
        ...
        public List<Node> DeliveryStructureList { get; set; }
    }
    ...
    public class AllDeliveryStcuctPAM
    {
        public List<DeliveryStcuctPAMDto> content { get; set; }
    ...
    public class DeliveryStcuctPAMDto
    {
        public string id { get; set; }
        public string name { get; set; }
        public string description { get; set; }
        public string parentId { get; set; }
        public string deliveryStructureId { get; set; }
